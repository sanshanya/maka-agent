...
export const TUI_COPY_RESOURCES = {
  ...
  'host-owner': {
    en: {
      ...
      usage: 'Usage: /host [status|stop|restart] or /update [latest|next|version]',
      pickerTitle: 'Runtime Host owner action',
      cancel: 'Cancel',
      cancelDescription: 'Keep this Host and its work running',
      safe: 'Safe handoff',
      safeDescription: 'Continue only at a verified safe boundary',
      interrupt: 'Interrupt active work',
      interruptDescription: 'May stop work from every attached Surface',
      pending: 'A Host owner action is already pending.',
      disconnected: 'The TUI has already disconnected.',
      foreign:
        'This TUI is attached to another Host. Run its owner controls on that Host; /exit only disconnects.',
      notOwner:
        'This npm-global installation does not own the local Host. Use its actual operator; /exit only disconnects.',
      hostChanged: 'The local Host changed or requires its managed-service operator.',
      ...
      root: 'Root: {root}',
      epoch: 'Epoch: {epoch}',
      composition: 'Composition: {composition} ({revision})',
      activity: 'Connections: {connections}; operations: {operations}; residencies: {residencies}',
      unknownActivity: 'Activity is unknown. Other Surfaces and autonomous tasks may be affected.',
      updateSafeOnly: 'Update supports safe handoff only.',
      invalidTarget: 'Update target must be latest, next, or an exact release version.',
      updateRequiresSafe:
        'TUI update uses safe handoff only. Stop active work explicitly before updating.',
      installationChanged: 'The npm-global installation changed. Reopen Maka before retrying.',
      ownerChanged: 'The local Host installation owner changed. Reopen Maka before retrying.',
      retirementHostChanged:
        'The Host changed before owner retirement; no replacement was interrupted.',
      activityChanged:
        'Host activity changed after confirmation. Reopen Maka and confirm the new work before retrying.',
      stillActive:
        'The Host still has active work. Reopen Maka and retry /host {action}; interruption requires a new confirmation.',
      restartFailed: 'Host restart did not complete: {detail}',
      status: '{name}: {state}',
      state_starting: 'Starting',
      state_containing: 'Containing',
      state_recovering: 'Recovering',
      state_ready: 'Ready',
      state_draining: 'Draining',
      localOwnerHint:
        'Owner controls require this npm-global installation to own the Host. /exit only disconnects.',
      attachedOwnerHint:
        'Attached Host: lifecycle changes require its operator. /exit only disconnects.',
    },
    'zh-CN': {
      unavailable: 'Runtime Host 所有者控制不可用。',
      usage: '用法：/host [status|stop|restart] 或 /update [latest|next|version]',
      pickerTitle: 'Runtime Host 所有者操作',
      cancel: '取消',
      cancelDescription: '保持此 Host 及其任务运行',
      safe: '安全交接',
      safeDescription: '仅在已验证的安全边界继续',
      interrupt: '中断活动任务',
      interruptDescription: '可能停止所有已连接界面的任务',
      pending: '已有 Host 所有者操作等待执行。',
      disconnected: 'TUI 已断开连接。',
      foreign: '此 TUI 连接的是其他 Host。请在该 Host 上使用其所有者控制；/exit 仅断开连接。',
      notOwner:
        '此 npm-global 安装不是本地 Host 的所有者。请使用实际所有者的控制工具；/exit 仅断开连接。',
      hostChanged: '本地 Host 已变更，或需要由其托管服务控制工具操作。',
      actionSummary: '{action}：{name}',
      action_stop: '停止',
      action_restart: '重启',
      action_update: '更新',
      ...
      root: '根标识：{root}',
      epoch: '实例标识：{epoch}',
      composition: '运行组成：{composition}（{revision}）',
      activity: '连接数：{connections}；操作数：{operations}；常驻任务：{residencies}',
      unknownActivity: '活动状态未知。其他界面和自主任务可能受到影响。',
      updateSafeOnly: '更新仅支持安全交接。',
      invalidTarget: '更新目标必须为 latest、next 或确切的发布版本。',
      updateRequiresSafe: 'TUI 更新仅使用安全交接。更新前请先显式停止活动任务。',
      installationChanged: 'npm-global 安装已变更。请重新打开 Maka 后重试。',
      ownerChanged: '本地 Host 的安装所有者已变更。请重新打开 Maka 后重试。',
      retirementHostChanged: '停止旧实例前 Host 已变更；未中断替代实例。',
      activityChanged: '确认后 Host 活动已变更。请重新打开 Maka，确认新的任务后重试。',
      stillActive: 'Host 仍有活动任务。请重新打开 Maka 并重试 /host {action}；中断需要重新确认。',
      restartFailed: 'Host 重启未完成：{detail}',
      status: '{name}：{state}',
      state_starting: '启动中',
      state_containing: '故障隔离中',
      state_recovering: '恢复中',
      state_ready: '就绪',
      state_draining: '排空中',
      localOwnerHint: '仅当此 npm-global 安装拥有该 Host 时才能使用所有者控制。/exit 仅断开连接。',
      attachedOwnerHint: '已连接的 Host：生命周期变更需由其所有者操作。/exit 仅断开连接。',
    },
    'zh-TW': {
      unavailable: 'Runtime Host 擁有者控制無法使用。',
      usage: '用法：/host [status|stop|restart] 或 /update [latest|next|version]',
      pickerTitle: 'Runtime Host 擁有者操作',
      cancel: '取消',
      cancelDescription: '保持此 Host 及其工作執行',
      safe: '安全交接',
      safeDescription: '僅在已驗證的安全邊界繼續',
      interrupt: '中斷進行中的工作',
      interruptDescription: '可能停止所有已連線介面的工作',
      pending: '已有 Host 擁有者操作等待執行。',
      disconnected: 'TUI 已中斷連線。',
      foreign: '此 TUI 連線的是其他 Host。請在該 Host 上使用其擁有者控制；/exit 僅中斷連線。',
      notOwner:
        '此 npm-global 安裝不是本機 Host 的擁有者。請使用實際擁有者的控制工具；/exit 僅中斷連線。',
      hostChanged: '本機 Host 已變更，或需要由其託管服務控制工具操作。',
      actionSummary: '{action}：{name}',
      action_stop: '停止',
      action_restart: '重新啟動',
      action_update: '更新',
      ...
      root: '根識別碼：{root}',
      epoch: '執行個體識別碼：{epoch}',
      composition: '執行組成：{composition}（{revision}）',
      activity: '連線數：{connections}；操作數：{operations}；常駐工作：{residencies}',
      unknownActivity: '活動狀態未知。其他介面和自主工作可能受到影響。',
      updateSafeOnly: '更新僅支援安全交接。',
      invalidTarget: '更新目標必須為 latest、next 或確切的發行版本。',
      updateRequiresSafe: 'TUI 更新僅使用安全交接。更新前請先明確停止進行中的工作。',
      installationChanged: 'npm-global 安裝已變更。請重新開啟 Maka 後重試。',
      ownerChanged: '本機 Host 的安裝擁有者已變更。請重新開啟 Maka 後重試。',
      retirementHostChanged: '停止舊執行個體前 Host 已變更；未中斷替代執行個體。',
      activityChanged: '確認後 Host 活動已變更。請重新開啟 Maka，確認新的工作後重試。',
      stillActive:
        'Host 仍有進行中的工作。請重新開啟 Maka 並重試 /host {action}；中斷需要重新確認。',
      restartFailed: 'Host 重新啟動未完成：{detail}',
      status: '{name}：{state}',
      state_starting: '啟動中',
      state_containing: '故障隔離中',
      state_recovering: '復原中',
      state_ready: '就緒',
      state_draining: '排空中',
      localOwnerHint: '僅當此 npm-global 安裝擁有該 Host 時才能使用擁有者控制。/exit 僅中斷連線。',
      attachedOwnerHint: '已連線的 Host：生命週期變更需由其擁有者操作。/exit 僅中斷連線。',
    },
  },
  copy: {
    en: {
  ...
  pickers: {
    en: {
      ...
      oauthFailures: {
        capability_unavailable: 'This client cannot present OAuth sign-in.',
        authorization_failed: 'Authorization did not complete. Try again.',
        provider_rejected: 'The provider rejected this account.',
        slug_taken: 'That slug is already taken. Pick another, or clear it to auto-assign.',
        credential_changed: 'The credential changed during sign-in. Try again.',
        connection_changed: 'The connection changed during sign-in. Reopen /setup.',
        persistence_failed: 'The signed-in account could not be saved. Try again.',
        internal_failure: 'OAuth sign-in failed. Try again.',
        connection_not_found: 'This connection no longer exists. Reopen /setup.',
        operation_conflict: 'Another OAuth login is active, or this identity is unavailable.',
        unavailable: 'Could not reach the Runtime Host. Try again.',
      },
      ...
      noConfigurableProviders: 'No configurable providers are available.',
      ...
      oauthHint: 'Open the device page and enter the sign-in code · Esc returns',
      oauthBackHint: 'Esc returns to provider selection',
      oauthCodeLabel: 'Sign-in code',
      oauthStarting: 'Preparing sign-in…',
      oauthWaiting: 'Waiting for browser authorization…',
      oauthCancelling: 'Cancelling sign-in…',
      oauthUnconfirmed: 'Sign-in result is not confirmed; it may have completed',
      oauthRecheckAction: 'Enter checks the sign-in result · Esc closes setup',
      oauthLoadingModels: 'Signed in · Loading models…',
      oauthContinueToModels: 'Signed in · Enter to continue to models',
      oauthRetryAction: 'Enter retry · Esc returns',
      oauthRetryModelsAction: 'Signed in · Enter retries model loading',
    ...
    'zh-CN': {
      ...
      oauthFailures: {
        capability_unavailable: '当前客户端无法呈现 OAuth 登录。',
        authorization_failed: '授权未完成，请重试。',
        provider_rejected: '服务商拒绝了该账号。',
        slug_taken: '该标识已被占用。请更换，或清空后自动分配。',
        credential_changed: '登录期间凭据已变化，请重试。',
        connection_changed: '登录期间连接已变化，请重新打开 /setup。',
        persistence_failed: '无法保存已登录的账号，请重试。',
        internal_failure: 'OAuth 登录失败，请重试。',
        connection_not_found: '该连接已不存在，请重新打开 /setup。',
        operation_conflict: '已有 OAuth 登录正在进行，或该连接标识不可用。',
        unavailable: '无法连接 Runtime Host，请重试。',
      },
      accountSavedRefreshFailed: '账号已保存，但模型列表暂未刷新。重启 Maka 后会重新载入。',
      listProvidersFailed: '无法读取已配置的连接。',
      noConfigurableProviders: '没有可配置的模型提供商。',
      ...
      oauthHint: '打开设备登录页面并输入验证码 · Esc 返回',
      oauthBackHint: 'Esc 返回选择服务商',
      oauthCodeLabel: '登录验证码',
      oauthStarting: '正在准备登录…',
      oauthWaiting: '正在等待浏览器授权…',
      oauthCancelling: '正在取消登录…',
      oauthUnconfirmed: '登录结果尚未确认，可能已经完成',
      oauthRecheckAction: 'Enter 查询登录结果 · Esc 关闭设置',
      oauthLoadingModels: '登录成功 · 正在加载模型…',
      oauthContinueToModels: '已登录 · Enter 继续选择模型',
      oauthRetryAction: 'Enter 重试 · Esc 返回',
      oauthRetryModelsAction: '已登录 · Enter 重试加载模型',
    ...
    'zh-TW': {
      ...
      oauthFailures: {
        capability_unavailable: '目前客戶端無法顯示 OAuth 登入。',
        authorization_failed: '授權未完成，請重試。',
        provider_rejected: '服務商拒絕了此帳號。',
        slug_taken: '該識別碼已被佔用。請更換，或清空後自動分配。',
        credential_changed: '登入期間憑證已變更，請重試。',
        connection_changed: '登入期間連線已變更，請重新開啟 /setup。',
        persistence_failed: '無法儲存已登入的帳號，請重試。',
        internal_failure: 'OAuth 登入失敗，請重試。',
        connection_not_found: '此連線已不存在，請重新開啟 /setup。',
        operation_conflict: '已有 OAuth 登入正在進行，或該連線識別碼無法使用。',
        unavailable: '無法連線 Runtime Host，請重試。',
      },
      accountSavedRefreshFailed: '帳號已儲存，但模型清單尚未重新整理。重新啟動 Maka 後會重新載入。',
      listProvidersFailed: '無法讀取已設定的連線。',
      noConfigurableProviders: '沒有可設定的模型服務商。',
      ...
      oauthHint: '開啟裝置登入頁面並輸入驗證碼 · Esc 返回',
      oauthBackHint: 'Esc 返回選擇服務商',
      oauthCodeLabel: '登入驗證碼',
      oauthStarting: '正在準備登入…',
      oauthWaiting: '正在等待瀏覽器授權…',
      oauthCancelling: '正在取消登入…',
      oauthUnconfirmed: '登入結果尚未確認，可能已經完成',
      oauthRecheckAction: 'Enter 查詢登入結果 · Esc 關閉設定',
      oauthLoadingModels: '登入成功 · 正在載入模型…',
      oauthContinueToModels: '已登入 · Enter 繼續選擇模型',
      oauthRetryAction: 'Enter 重試 · Esc 返回',
      oauthRetryModelsAction: '已登入 · Enter 重試載入模型',
  ...
  'primary-guidance': {
    en: {
      ...
      commands: {
        ...
        exit: 'Disconnect this TUI; leave the attached Host running',
        host: 'Inspect the Host or stop/restart its local owner',
        update: 'Update the npm-global CLI and its local Host',
    ...
    'zh-CN': {
      ...
      commands: {
        ...
        exit: '断开此 TUI，保留已连接的 Host',
        host: '查看 Host 状态或停止、重启本地所有者',
        update: '更新 npm 全局 CLI 及其本地 Host',
        goal: '查看自主目标状态',
  ...
  'connection-identity': {
    en: {
      ...
      emptyChoiceRecovery:
        'If /model has no choices, add or enable a connection first (run /setup to add one).',
      confirmAccount:
    ...
    'zh-CN': {
      withRecovery: '{notice}{recovery}',
      emptyChoiceRecovery: '如果 /model 没有可选项，请先添加或启用连接（可运行 /setup 添加）。',
