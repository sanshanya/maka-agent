...
const SETTINGS_NAVIGATION_COPY_BY_LOCALE = {
  'zh-CN': {
    ...
    sections: {
      ...
      'external-agents': { label: '外部 Agent', description: '配置并登录本机安装的 Antigravity ACP。' },
      ...
      'import-tasks': { label: '导入/导出任务', description: '把本机其他 Agent 的对话记录转换成 Maka 任务，或在两个 Maka 之间搬运任务。' },
  ...
  'zh-TW': {
    ...
    sections: {
      ...
      'external-agents': { label: '外部 Agent', description: '設定並登入本機安裝的 Antigravity ACP。' },
      ...
      'import-tasks': { label: '匯入/匯出任務', description: '把本機其他 Agent 的對話記錄轉換成 Maka 任務，或在兩個 Maka 之間搬運任務。' },
  ...
  en: {
    ...
    sections: {
      ...
      'external-agents': { label: 'External Agents', description: 'Configure and sign in to a locally installed Antigravity ACP agent.' },
      ...
      'import-tasks': { label: 'Import/export tasks', description: 'Convert conversations from another local agent into Maka tasks, or move a task between two Maka installations.' },
